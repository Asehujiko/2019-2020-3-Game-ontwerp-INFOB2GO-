...
public class HPbar : MonoBehaviour
{
    ...
    public GameObject heathbaroutline;
    ...
    void Start()
    {
        heathbaroutline.transform.position = new Vector3(Screen.width - 80, Screen.height - 50, 0);
        transform.position = new Vector3(Screen.width - 80, Screen.height - 50, 0);
